...
<body class="bg-black text-white">
    <div class="min-h-screen flex flex-col">
        ...
        <header class=" fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-90 backdrop-blur-sm" data-delay="0">
            <nav class="container mx-auto px-6 py-6 flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-10 font-orbitron text-lg text-white">
                    ...
                    <a class="hover:text-cyan-400 tracking-widest transition-all duration-300 hover:scale-110" href="contact.php">CONTACT US</a>
  ...
  <section id="carousel" class="carousel-section animate-element duration-100" data-delay="0">
    <div class="carousel-title animate-element zoom-in duration-100" data-delay="200">
        <h2 class="hero-title text-4xl md:text-5xl font-orbitron font-bold tracking-wide leading-tight mb-4">
            Our Top Products
        </h2>
    </div>

    <div class="carousel animate-element fade-in duration-1\]00" data-delay="300">
        <div class="list">
...
<section class="categories-section" id="categories-section">
    ...
    <div class="category-grid">
       ...
       <section id="feature" class="feature bg-black text-white py-16 px-6 duration-1000" data-delay="0">
    ...
    <div class="container mx-auto px-6">
        ...
        <section id="testimonial" class="bg-black py-16 px-6 duration-1200" data-delay="0">
    <div class="max-w-7xl mx-auto text-center">
        <div class="carousel-title animate-element zoom-in" data-delay="200">
            <h2 class="hero-title text-4xl md:text-5xl font-orbitron font-bold tracking-wide leading-tight mb-4">
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-gray-400 text-sm mb-6">Subscribe to get special offers, free eaways, and exclusive deals.</p>
            ...
            <!-- Company -->
            <div>
                <h4 class="text-lg font-bold text-cyan-400 mb-4 uppercase tracking-wide">Categories</h4>
                <ul class="space-y-3">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="index.php#carousel" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">Top Products</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="index.php#testimonial" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">Testimonial</a></li>
                    <li><a href="index.php#feature" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">Our Factor</a></li>
                    <li><a href="index.php#faq" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">FAQ</a></li>
                    <li><a href="contact.php" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">Contact Us</a></li>
                    <li><a href="index.php" class="text-gray-400 hover:text-cyan-300 transition-colors text-sm">Home</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-cyan-800 mt-12 pt-8">
            <div class="text-center">
                <div class="text-4xl font-serif font-bold text-cyan-400 mb-4">ALPHA CYCLES</div>
